...
describe('PUBLIC -- HtmlChecker', () => {
  ...
  describe('options', () => {
    ...
    it('excludedKeywords = […]', done => {
      ...
      new HtmlChecker(
        helpers.options({ excludedKeywords: [conn.absoluteUrls[0]] }),
        {
    ...
    it('excludedSchemes = []', done => {
      ...
      htmlString +=
        '<a href="mailto:address@email.com?subject=hello">link4</a>';
    ...
    it('honorRobotExclusions = false (rel)', done => {
      ...
      htmlString +=
        '<a href="' + conn.absoluteUrls[0] + '" rel="tag nofollow">link2</a>';
      htmlString +=
        '<a href="' +
        conn.absoluteUrls[0] +
        '" rel=" TAG  NOFOLLOW ">link3</a>';
