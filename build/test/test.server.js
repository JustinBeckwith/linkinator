...
describe('server with cleanUrls', () => {
    ...
    it('should resolve extensionless URL to .html file', async () => {
        ...
        const data = await response.text();
        assert.strictEqual(response.status, 200);
        assert.strictEqual(data, '<html><body><h1>About Page</h1><a href="contact">Contact</a></body></html>\n');
    });
    it('should resolve nested extensionless URL to .html file', async () => {
        ...
        const data = await response.text();
        assert.strictEqual(response.status, 200);
        assert.strictEqual(data, '<html><body><h1>Contact Page</h1></body></html>\n');
    });
    ...
    it('should serve index.html for root path', async () => {
        ...
        const data = await response.text();
        assert.strictEqual(response.status, 200);
        assert.strictEqual(data, '<html><body><h1>Home Page</h1><a href="about">About</a></body></html>\n');
    });
