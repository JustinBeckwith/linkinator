...
describe('url-utils', () => {
    describe('normalizeBaseUrl', () => {
        ...
        it('should handle URLs with ports', () => {
            const result = normalizeBaseUrl('http://example.com:3000/api/users', false);
            assert.strictEqual(result, 'http://example.com:3000/api/users/');
        });
        it('should handle URLs with query parameters', () => {
            const result = normalizeBaseUrl('http://example.com/search?q=test', false);
        ...
        describe('edge cases', () => {
            ...
            it('should handle URL with multiple dots in filename', () => {
                const result = normalizeBaseUrl('http://example.com/file.test.html', false);
        ...
        describe('issue #374 scenarios', () => {
            it('should fix the harmonograph example from issue #374', () => {
                ...
                assert.strictEqual(resolvedUrl.href, 'http://localhost:8080/apps/web/harmonograph');
            });
            it('should fix Sphinx documentation links', () => {
                ...
                assert.strictEqual(searchUrl.href, 'http://example.com/docs/api/search.html');
                const introUrl = new URL('01_introduction.html', baseUrl);
                assert.strictEqual(introUrl.href, 'http://example.com/docs/api/01_introduction.html');
            });
        });
    });
});
